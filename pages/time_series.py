...
with col2:
    with st.expander("About Sales Predictions",expanded=True):
...
future_pred = SARIMAX(train, order=(1, 1, 1), seasonal_order=(1,1,1,30)).fit().predict(start=len(y), end=len(y)+12, typ='levels')
